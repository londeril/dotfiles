...
dbus-update-activation-environment --systemd WAYLAND_DISPLAY QT_QPA_PLATFORMTHEME GTK_THEME 
...
systemctl --user import-environment WAYLAND_DISPLAY QT_QPA_PLATFORMTHEME GTK_THEME
