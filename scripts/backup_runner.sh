...
backup)
  ...
  pkexec restic -r sftp:daniel@172.16.3.10:/mnt/storage/DashwoodStore/NovaBackup backup / --password-file="/home/daniel/.NovaBackup" --exclude-file="/home/daniel/.dotfiles/novasystem-excludes.restic"
